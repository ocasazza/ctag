...
"""
Add command module for the ctag CLI tool.

This module defines the 'add' command for adding tags to Confluence pages.
"""
...
@click.option('--dry-run', is_flag=True, help="Preview changes without making any modifications")
@click.pass_context
